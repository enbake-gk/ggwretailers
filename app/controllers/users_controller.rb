class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:retailer_group_id, :retailer_name,:contact_person, :website, :retailer_name, :phone_number, :email, :first_name,:last_name).merge(:role_id=>"2", :password => "U1tZyyLVTD")
    end
end
