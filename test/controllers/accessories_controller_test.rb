...
class AccessoriesControllerTest < ActionController::TestCase
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post :create, accessory: { name: @accessory.name, price: @accessory.price, url: @accessory.url, user_id: @accessory.user_id }
    end
  ...
  test "should update accessory" do
    patch :update, id: @accessory, accessory: { name: @accessory.name, price: @accessory.price, url: @accessory.url, user_id: @accessory.user_id }
    assert_redirected_to accessory_path(assigns(:accessory))
  end
